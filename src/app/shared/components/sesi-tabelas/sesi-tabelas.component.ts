...
import { IBtnAcoesCustom, IColunas } from '../../../model/components/sesi-tabelas';
import { ConfirmationService, MessageService } from 'primeng/api';

@Component({
  selector: 'sesi-tabelas',
  templateUrl: './sesi-tabelas.component.html',
  styleUrls: ['./sesi-tabelas.component.scss']
})
export class SesiTabelasComponent implements OnInit {
  @Input() dados!: any[];
