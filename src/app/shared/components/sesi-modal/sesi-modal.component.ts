...
import { IForms } from '../../../model/components/sesi-forms';

@Component({
  selector: 'sesi-modal',
  templateUrl: './sesi-modal.component.html',
  styleUrls: ['./sesi-modal.component.scss']
})
export class SesiModalComponent implements OnInit {
  @Input() titulo!: string;
