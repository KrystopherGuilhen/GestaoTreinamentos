    ...
    imports: [
        RouterModule.forChild([
            ...
            },
            {
                ...
                data: { breadcrumb: 'Registro Palestrante' },
                loadChildren: () =>
                    import('./cadastroProfessor/cadastro-professor.module').then(
                        (m) => m.CadastroProfessorModule),
            },
            {
                path: 'cadastroProfessorOld',
                data: { breadcrumb: 'Registro Palestrante Old' },
                loadChildren: () =>
                    import('./cadastroProfessorOld/cadastroProfessorOld.module').then(
                        (m) => m.CadastroProfessorOldModule),
            },
            {
                path: 'input',
