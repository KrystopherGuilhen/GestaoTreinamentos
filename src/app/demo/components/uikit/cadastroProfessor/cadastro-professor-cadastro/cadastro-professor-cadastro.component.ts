...
@Component({
    selector: 'sesi-cadastro-professor-cadastro',
    templateUrl: '../../../../../shared/templates/crud-forms-template.html',
    styleUrls: ['./cadastro-professor-cadastro.component.scss'],
})
export class CadastroProfessorCadastroComponent extends CrudFormsAbstractComponent {
    modalProps: IModal = {
        titulo: 'Cadastrar',
        exibeModal: false,
        largura: '800px',
        ...
        this.formCadastro = [
            {
                ...
                visivel:
                    ...
                    !this.cadastro.preencherArquivo,
                formModel: 'todosDealers',
                tipoDado: 'logico',
                optInput: {
                    text: 'Todos os Dealers',
                    onChange: (event: any) =>
                        this.retornaCondicaoTodosDealers(event),
                },
            },
            {
                colSpan: 6,
                ...
                optInput: {
                    ...
                    onChange: (event: any) =>
                        this.retornaCondicaoPreencherArquivo(event),
                },
            },
            {
                colSpan: 12,
                visivel:
                    !this.cadastro.todosDealers &&
                    !this.cadastro.preencherArquivo,
                formModel: 'id_dealer',
                descricao: 'Dealers',
                tipoDado: 'lista',
            ...
            // },
            {
                ...
                optInput: {
                    ...
                    onClick: (event: any) =>
                        this.retornaCondicaoTipoValor(event),
                },
            },
            {
                colSpan: 12,
                ...
                optInput: {
                    fileUploadHint: {
                        visivel: true,
                        hints: this.retornaHintsFileUpload(),
                    },
                    fileUploadBtn: {
                        visivel: true,
                        toolTip: 'Baixar o modelo',
                        onClick: () => alert('baixa arquivo'),
                    },
                },
            },
        ];
    ...
    private retornaCondicaoPreencherArquivo(preencherArquivo: boolean): void {
        ...
        preencherArquivo
            ? (this.modalProps.largura = '950px')
            : (this.modalProps.largura = '800px');
